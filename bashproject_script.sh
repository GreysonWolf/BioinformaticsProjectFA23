...
# this code takes our final output file and creates a table
...
# this code sorts the datafile with the proteome that has the most hsp70 matches at the top
echo "ProteomeNumber,mcrAMatches,hsp70Matches" > sortedcandidates.csv
cat candidates.csv |  sort -k3 -n -r >> sortedcandidates.csv

# this code will create a table of the sorted candidates
